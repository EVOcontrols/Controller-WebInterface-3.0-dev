...
export default class ScrollBooster {
   ...
   * @param {String=} options.preventDefaultOnEmulateScroll
   * @param {Function=} options.onClick - click handler
   * @param {Function=} options.onUpdate - state update handler
   * @param {Function=} options.onPointerDown
   * @param {Function=} options.onPointerUp
   * @param {Function=} options.onPointerMove
  ...
  setContentPosition(state) {
    if (this.props.scrollMode === 'transform') {
      this.props.content.style.transform = `translate(${-state.position.x}px, ${-state.position
        .y}px)`;
    }
